...
* The original package name 'com.demo.microservices.currency-exchange-service' is invalid and this project uses 'com.demo.microservices.currencyexchangeservice' instead.
