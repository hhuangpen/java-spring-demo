...
* The original package name 'com.demo.microservices.currency-conversion-service' is invalid and this project uses 'com.demo.microservices.currencyconversionservice' instead.
